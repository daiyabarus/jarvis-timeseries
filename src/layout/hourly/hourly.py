...
from gsmhourly import gsm_hourly_page
from ltehourly import lte_hourly_page
from nrhourly import nr_hourly_page
from prbhourly import prb_hourly_page
    ...
    def create_tabs(self):
        opt = sac.buttons(
            [
                ...
                sac.ButtonsItem(label="PRB", icon="bar-chart-fill"),
            ],
            align="center",
            radius="sm",
            color="#4682b4",
